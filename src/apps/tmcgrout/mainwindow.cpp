...
void MainWindow::createMenus()
{
    ...
    help->addAction(makeAction(ID_APP_ABOUT, QStringLiteral("&About TMCGROUT...")));
}
...
{
    tmcabout::show(this, QStringLiteral("About TMCGROUT"),
                   QStringLiteral("TMCGROUT"),
                   QStringLiteral("Просмотр выходных характеристик "
                                  "S-матриц пакета TMC Suite."));
}
